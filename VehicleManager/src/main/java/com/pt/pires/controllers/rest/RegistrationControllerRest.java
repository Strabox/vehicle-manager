 ...
 */
@RestController
public class RegistrationControllerRest extends ControllerExceptionHandler {
	...
	public RegistrationControllerRest(IRegistrationService rs) {
		registrationService = rs;
	}
	
	public RegistrationControllerRest() { }
